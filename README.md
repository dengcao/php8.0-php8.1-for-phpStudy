# php8.0至php8.5 for phpStudy（小皮面板）（内含所需VC运行库）

phpstudy 8.1是个很好用的PHP集成环境软件，可惜官方很久没更新了，官方只支持到PHP8.0和PHP8.2，因为近期项目需要用到PHP8.5，所以自己动手配置了，考虑到很多网友可能也有这个需要，所以这里共享一下phpstudy8.1快速配置php8.0至php8.5的方法。已配置好的文件，直接复制粘贴后，就可以拿来用了。
...
### phpstudy8.1安装php8.0.14nts至php8.5.3nts的方法
...
2、直接复制php8.0.14nts至php8.5.3nts等多个PHP文件夹到：D:\phpstudy_pro\Extensions\php
